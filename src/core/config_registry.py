...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "EXTERNAL_HOLDINGS_ENABLED": {
        "title": "External Holdings Snapshot",
        "description": "Enable screenshot-based external holdings snapshots and related APIs.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "HOLDING_SCREENSHOT_REMINDER_ENABLED": {
        "title": "Holdings Screenshot Reminder",
        "description": "Enable schedule-mode reminders to update Tonghuashun stock and Alipay fund screenshots.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "HOLDING_SCREENSHOT_REMINDER_STOCK_TIME": {
        "title": "Stock Screenshot Reminder Time",
        "description": "Reminder time in HH:MM for Tonghuashun stock holdings screenshots.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "HOLDING_SCREENSHOT_REMINDER_FUND_TIME": {
        "title": "Fund Screenshot Reminder Time",
        "description": "Reminder time in HH:MM for Alipay fund holdings screenshots.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "HOLDING_SCREENSHOT_REMINDER_CHANNELS": {
        ...
        "description": "Comma-separated reminder channels. Supported: feishu,email.",
        "category": "system",
        "data_type": "array",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "feishu,email",
        "options": [],
        "validation": {},
        "display_order": 15,
    },
    "HOLDING_SCREENSHOT_DOC_SYNC_ENABLED": {
        "title": "Auto Sync Holdings Doc",
        "description": "Automatically sync the latest confirmed screenshot snapshot to Feishu Doc when available.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "HOLDING_SCREENSHOT_AUTO_MERGE_STOCK_LIST": {
        "title": "Auto Merge Watchlist",
        "description": "Automatically merge extracted stock and ETF symbols into STOCK_LIST after manual confirmation.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "HOLDING_SCREENSHOT_STALE_REMINDER_HOURS": {
        "title": "Snapshot Stale Reminder Hours",
        "description": "Reserved threshold used by stale-snapshot reminder checks.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "OCR_SERVICE_ENABLED": {
        "title": "Shared OCR Service",
        "description": "Use the shared OCR gateway before holdings parsing.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "OCR_SERVICE_BASE_URL": {
        "title": "OCR Service Base URL",
        "description": "Base URL of the shared OCR gateway, e.g. http://ocr-gateway:8090.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "OCR_SERVICE_API_KEY": {
        "title": "OCR Service API Key",
        "description": "Optional bearer token used by the shared OCR gateway.",
        "category": "system",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "OCR_SERVICE_TIMEOUT_SECONDS": {
        ...
        "description": "Timeout in seconds for shared OCR gateway requests.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
